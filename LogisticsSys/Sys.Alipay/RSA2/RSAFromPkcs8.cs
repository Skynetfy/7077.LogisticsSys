...
namespace Sys.RSA2.Alipay
{
    public sealed class RSAFromPkcs8
    {
        ...
        /// 签名sign
        /// </summary>
        /// <param name="content">需要签名的内容pre-sign</param>
        /// <param name="privateKey">私钥private key</param>
        /// <param name="input_charset">编码格式charset</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// 验证签名 RSA sign verification
        /// </summary>
        /// <param name="content">需要验证的内容the content to be verified</param>
        /// <param name="signedString">签名结果verify result</param>
        /// <param name="publicKey">公钥public key</param>
        /// <param name="input_charset">编码格式charset</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// 用RSA解密decrypt with RSA
        /// </summary>
        /// <param name="resData">待解密字符串 cryptograph</param>
        /// <param name="privateKey">私钥private key</param>
        /// <param name="input_charset">编码格式charset</param>
        /// <returns>解密结果result</returns>
        ...
        /// <summary>
        /// 解析java生成的pem文件私钥
		/// Parse the private key of the pem file generated of Java  
        /// </summary>
